                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="incoming-img bg-img" id="user-image" style={{ backgroundImage: 'url(' + "http://expressdrivegh.com/storage/app/public/"+this.props.request.user.picture + ')' }}></div>
