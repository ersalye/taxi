      ...
      <div class="">
        <div class="col-md-12">
            ...
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <div class="navbar-left" style="margin-top: 5px;margin-bottom: 5px;">
                <a class="" href="{{url('/provider/login')}}"><img src="{{ Setting::get('site_logo', asset('logo-black.png')) }}" style="height:50px;"></a>
              </div>
            </div>
                         ...
                         <form id="form_online" method="POST" action="{{url('/provider/profile/available')}}">
                            ...
                            <!--  <input checked  name="CARD" id="stripe_check" type="checkbox" class="js-switch" data-color="#43b968"> -->
                              <label class="switch" id="stripe_check">
                                <input type="checkbox" name="CARD" checked="checked">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu">
                            <li class="row no-margin">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <a href="{{ route('provider.profile.profile') }}" class="new-pro-link">My Profile</a>
                                </div>
                            </li>
