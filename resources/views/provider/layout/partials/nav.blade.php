            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('provider.upcoming')}}" class="waves-effect waves-light">
                        ...
                        <span class="s-text user-dashboard">Scheduled Trips</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('provider.documents.index') }}" class="waves-effect waves-light">
                        ...
                        <span class="s-text user-dashboard">My Documents </span>
                    </a>
                </li>
                
                <li>
                    <a href="{{ route('provider.location.index') }}" class="waves-effect waves-light">
                        <span class="s-icon"><i class="ti-location-pin user-sidebaricon"></i></span>
                        <span class="s-text user-dashboard">My Location </span>
                    </a>
                </li>
                   <!--  </ul> -->
                <!-- </li> -->
                ...
                <li>
                    <a href="{{ route('provider.faq')}}" class="waves-effect waves-light">
                ...
                <li>
                    <a href="{{ route('provider.terms')}}" class="waves-effect waves-light">
                ...
                <li>
                    <a href="{{ route('provider.help')}}" class="waves-effect waves-light">
