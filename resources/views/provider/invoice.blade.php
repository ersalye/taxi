                        ...
                        <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="33%" style="text-align:left;">
                                     <img src="{{ asset('asset/img/rider_logo.png') }}">
                                </td>
...
<table id="email-penrose-conteneur" width="660" align="center" style="border-right:1px solid #e2e8ea; border-bottom:1px solid #e2e8ea; border-left:1px solid #e2e8ea; background-color:#ffffff;" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td style="background-color:#3e79b8">
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
        ...
        <td>
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0" style="padding:20px;">
                ...
                <td width="100%">
                    ...
                    <table width="300" align="left" class="resp-full-table" style="margin:0 auto;float:none;background-color:#3e79b8; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="100%" class="resp-full-td" valign="top" style="text-align: justify; padding:20px;">
                                ...
                                <div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Distance Fare</span><span style="float:right;"><?php echo round($email_data['distance'], 2); ?> </span></div>
                                <div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Tax Fare</span><span style="float:right;"><?php echo $email_data['tax_fare']; ?></span></div>
                                <div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Wallet Detection</span><span style="float:right;"><?php echo $email_data['wallet_detection']; ?></span></div>
                                <div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Promotion Applied</span><span style="float:right;"><?php echo $email_data['promotion_applied']; ?></span></div>
                                <div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Total</span><span style="float:right;"><?php echo $email_data['total']; ?></span></div>
                    ...
                    <!-- Début bloc info 2 -->
                                                        ...
                                                        <!-- <table width="300" align="left" class="resp-full-table" style="background-color:#3e79b8; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                        <td width="100%" class="resp-full-td" valign="top" style="text-align: justify; padding:20px;">
                    ...
                    <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                <div style="background:#3e79b8;padding: 10px;font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff">TOTAL<span style="float:right;"><?php echo /* $currency->keyword */Config::get('app.generic_keywords.Currency') . '₵ ' . $email_data['total']; ?></span></div>
                            </td>
                        </tr>
    ...
    <tr>
        <td>
            <table width="600" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="100%" class="resp-full-td" style="text-align: center;"><span style="font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#aeb2b3">Fares are inclusive of service tax and all other taxes applicable. </span>
