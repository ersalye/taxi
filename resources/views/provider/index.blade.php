    ...
    <div class="row row-md">
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                ...
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Today Trips</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                ...
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Completed Trips</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                ...
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Total Trips</h4>
     ...
     <div class="row row-md">
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                <!--div class="t-icon right"><span class="bg-danger"></span><i class="ti-rocket"></i></div-->
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Trips Accepted</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                <!--div class="t-icon right"><span class="bg-success"></span><i class="ti-bar-chart"></i></div-->
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Cancelled Trips</h4>
        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="box box-block bg-white tile tile-1 mb-2">
                <!--div class="t-icon right"><span class="bg-primary"></span><i class="ti-view-grid"></i></div-->
                <div class="t-content">
                    <h4 class="text-uppercase mb-1">Scheduled Trip</h4>
