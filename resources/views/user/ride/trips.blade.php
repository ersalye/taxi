...
<div class="col-md-12" style="margin-bottom: 20px;">
    ...
    <div class="dash-content">
        ...
        <div class="row no-margin">
            <div class="col-md-6">
                        ...
                        <div class="car-radio">
                            ...
                            <label for="service_{{$service->id}}">
                                <div class="car-radio-inner">
                                    ...
                                    <div class="img"><img src="{{asset($service->image)}}"></div>
                ...
                <input type="submit" name="submit" value="Ride Now" class="full-primary-btn fare-btn">
                   <!--  <button type="button"  class="full-primary-btn fare-btn" data-toggle="modal" data-target="#myModal">@lang('user.ride.ride_now')</button>-->
                </form>
            </div>
    ...
    <div class="dash-content" style="margin-top: 20px;">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title">Recent Trips</h4>
            </div>
        </div>
...
<script type="text/javascript">
    var current_latitude = 28.207609;
    var current_longitude = 79.826660;
</script>
...
<!-- AIzaSyDFVF5e-GYymNXLfS9567IcpHiAiuhfFzI -->
<script type="text/javascript" src="{{ asset('asset/js/map.js') }}"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDFVF5e-GYymNXLfS9567IcpHiAiuhfFzI&libraries=places&callback=initMap" async defer></script>
