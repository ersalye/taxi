...
<div class="index">
        ...
        <div class="reasons">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                    <div class="easiest">
                        <figure><img src="img/image01.png" alt="img"/></figure>
                ...
                <div class="reasons_btn">
                    <a class="btn btn-default">Reasons to ride <figure><img src="img/btn_arrow.png" alt="img"></figure></a>
                </div>
                </div>
                    <div class="col-md-4">
                    <div class="easiest">
                        <figure><img src="img/image02.png" alt="img"/></figure>
                        <h4>Anywhere, anytime</h4>
                        <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on Instacab for a ride—no reservations required.</p>
                    </div>
                </div>
                    <div class="col-md-4">
                    <div class="easiest">
                        <figure><img src="img/image03.png" alt="img"/></figure>
            ...
            <div class="container">
                <div class="community_text">
                    ...
                    <div class="community_btn">
                        <a class="btn btn-default">Read stories <figure><img src="img/btn_arrow.png" alt="img" /></figure></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="pricing_left">
                            ...
                            <div class="pickup_location">
                                <input class="form-control" placeholder="Enter Pickup Location">
                            <figure><img src="img/location_input.png" alt="img"/></figure>
                            </div>
                            <div class="destination">
                                <input class="form-control" placeholder="Enter Destination">
                                <figure><img src="img/destination.png" alt="img"/></figure>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
        ...
        <div class="therd_banner">
            <div class="container">
                <div class="therd_banner_text">
                    ...
                    <p>Driving with Instacab is flexible and rewarding, helping drivers meet their career and financial goals. </p>
                    <div class="community_btn">
                        <a class="btn btn-default">Read stories <figure><img src="img/btn_arrow.png" alt="img" /></figure></a>
                    </div>
                </div>
        ...
        <div class="our_drivers">
            <div class="container">
                <div id="owl-demo2" class="owl-carousel owl-theme">
                    <div class="owl-item">
                        <div class="item">
                            <figure><img src="img/our_driver1.jpg" alt="img" /></figure>
                            <div class="drivers_img_txt">             
                                <p>"I started driving with Instacab because I liked the idea that my own car could make me money. After just about a couple weeks, I saw that this was something I wanted to do permanently." </p>
                                <small><strong>Jenny,</strong> Business owner and Los Angeles partner</small>
                            </div>
                        </div>
                    </div>
                    <div class="owl-item">
                        <div class="item">
                            <div class="drivers_img_txt">
                                <figure><img src="img/our_driver2.jpg" alt="img" /></figure>
                                <p>"I started driving with Instacab because I liked the idea that my own car could make me money. After just about a couple weeks, I saw that this was something I wanted to do permanently." </p>
                                <small><strong>Jenny,</strong> Business owner and Los Angeles partner</small>
                            </div>
                        </div>
                    ...
                    <div class="owl-item">
                        <div class="item">
                            <div class="drivers_img_txt">
                                <figure><img src="img/our_driver3.jpg" alt="img" /></figure>
                                <p>"I started driving with Instacab because I liked the idea that my own car could make me money. After just about a couple weeks, I saw that this was something I wanted to do permanently." </p>
                                <small><strong>Jenny,</strong> Business owner and Los Angeles partner</small>
                            </div>
                        </div>
                    ...
                    <div class="owl-item">
                        <div class="item">
                            <div class="drivers_img_txt">
                                <figure><img src="img/our_driver4.jpg" alt="img" /></figure>
                                <p>"I started driving with Instacab because I liked the idea that my own car could make me money. After just about a couple weeks, I saw that this was something I wanted to do permanently." </p>
                                <small><strong>Jenny,</strong> Business owner and Los Angeles partner</small>
                            </div>
                        </div>
        ...
        <div class="unlocking_cities">
            <div class="container">
                <div class="unlocking_text">
                    <h3>Unlocking cities</h3>
                    <small>Imagine a world with fewer, fuller cars</small>
                    <p>When was the last time you were stuck in traffic? Yesterday? A few hours ago? Our cities are home to millions of cars, and the truth is that our streets weren’t built to handle them all.</p>
                    <p>The good news is that we can all do something about it. Let’s #ridetogether and unlock our cities.</p>
        ...
        <div class="find_city">
            <div class="container">
                <div class="city_text">
                    <h3>Instacab is in San Francisco</h3>
                </div>
                <p>and 632 other cities worldwide</p>
                <div class="city-form">
                    <input type="text" class="form-control" placeholder="Enter city">
                    <a href="#"><img src="img/destination.png" alt="arrow"/></a>
                </div>
            </div>
        </div>   
            ...
            <div class="container">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <ul>
                            <li><figure><img src="img/location.png" alt="location"/></figure> <small><a href="/enter_location">Enter your location</a></small></li>
                            <li>
                                <div class="language">
                        ...
                        <li><a  href="/fare_estimate"><!-- react-text: 564 -->Fare Estimate<!-- /react-text --></a></li>
                        ...
                        <li ><a href="aboutus.html" ><!-- react-text: 593 -->Our Story<!-- /react-text --></a></li>
