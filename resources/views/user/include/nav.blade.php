            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{url('mytrips')}}" class="waves-effect waves-light">
                        ...
                        <span class="s-text user-dashboard">@lang('user.list_trip')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{url('trips')}}" class="waves-effect waves-light">
                        <span class="s-icon"><i class="ti-car user-sidebaricon"></i></span>
                        <span class="s-text user-dashboard">@lang('user.my_trips')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{url('upcoming/trips')}}" class="waves-effect waves-light">
                        ...
                        <span class="s-text user-dashboard">@lang('user.upcoming_trips')</span>
                    </a>
                </li>
