    ...
    <div class="row row-md">
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-success mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Total Trip</h5>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-warning mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Total Cab</h5>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-danger mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Cancelled Trip</h5>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-success mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Cancelled Trip (Passenger)</h5>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-primary mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Cancelled Trip (Driver)</h5>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-danger mb-2">
				<div class="t-content">
					<h5 class="text-uppercase mb-1">Scheduled Trip</h5>
