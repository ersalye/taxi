...
Route::group(['as' => 'dispatcher.', 'prefix' => 'dispatcher'], function () {
    ...
    Route::get('/create', 'DispatcherController@indexcreate')->name('indexcreate');
...
Route::get('/help', 'Resource\HelpController@helps')->name('help');
Route::post('/help', 'Resource\HelpController@create')->name('help');
