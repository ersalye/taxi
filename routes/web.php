...
*/
//User sign in
Route::get('/Signin', 'SignInControlller@index');
Route::get('/PassengerSignin', 'SignInControlller@passengerSignin');
...
Route::post('/create/item', 'RideController@create_item');
// ride
...
Route::get('/about_us', 'CommonController@about_us');
...
Route::get('/pushnotification' , 'SchedulePushNotification@sendSchedulePushToProvider');
